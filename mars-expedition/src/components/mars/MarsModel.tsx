  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        ...
        <PerspectiveCamera name="Camera" makeDefault={true} far={1000} near={0.1} fov={22.895} position={[-5.743, 2.771, -3.815]} rotation={[-2.324, -1.07, -2.269]} />
        <mesh name="Mars" geometry={nodes.Mars.geometry} material={materials.Mars} rotation={[-Math.PI, 0.654, -Math.PI]} />
      </group>
    </group>
  );
}
